        ...
        self.valid_qobj = PulseQobj(
            ...
            experiments=[
                PulseQobjExperiment(instructions=[
                    ...
                    PulseQobjInstruction(name='setf', t0=10, ch='d0', frequency=8e9),
                    PulseQobjInstruction(name='shiftf', t0=10, ch='d0', frequency=4e9),
        ...
        self.valid_dict = {
            ...
            'experiments': [
                {'instructions': [
                    ...
                    {'name': 'setf', 't0': 10, 'ch': 'd0', 'frequency': 8e9},
                    {'name': 'shiftf', 't0': 10, 'ch': 'd0', 'frequency': 4e9},
